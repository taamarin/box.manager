...
class ClashData(private val masuk: String, private val indent: Boolean) {
    ...
    fun newVmessConfig(): String {
        ...
        sb.appendLine("${idnt}name: ${jo.optString("ps", jo.optString("add", "new"))}")
        ...
        when (jo.optString("net", "tcp")) {
            "ws" -> {
                ...
                sb.appendLine("${idnt}    Host: ${jo.getString("host")}")
            }

            "grpc" -> {
                sb.appendLine("${idnt}network: grpc")
                sb.appendLine("${idnt}grpc-opts:")
                sb.appendLine("${idnt}  grpc-service-name: ${jo.getString("host")}")
            }
    ...
    fun newVlessConfig(): String {
        ...
        sb.appendLine("${idnt}name: ${uri.fragment ?: "new"}_${uri.scheme}_${Random.nextInt(0, 7000)}")
        ...
        when (type) {
            "ws" -> {
                ...
                sb.appendLine("${idnt}  headers:")
                sb.appendLine("${idnt}    Host: $decodeHost")
            }
